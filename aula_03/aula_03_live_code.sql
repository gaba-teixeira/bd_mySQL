...
-- para verificar se o seu db é sensivel a case e acento - se tiver ai_ci - ele ignora acento e a case - as_cs - ele leva em conta toos os caracteres
...
SELECT round(avg(preco), 4) as media FROM tb_produtos;


-- soma 
SELECT count(nome) as contar FROM tb_produtos;
...
SELECT tb_categorias.descricao, avg(preco) as preco_media
